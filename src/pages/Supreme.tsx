...
export default function Supreme() {
  ...
  return (
    <>
      <SEO
        title="Supreme Furniture in Neemuch - Authorized Dealer | Chairs, Tables, Storage"
        description="Buy Supreme furniture in Neemuch from Hari Shewa Enterprises, authorized wholesale dealer. Complete range: plastic chairs, tables, storage, kids furniture, stools, beds. Best prices in Neemuch. Bulk orders available. Call +91 99815 16171."
        canonical="/supreme"
        ogImage="https://mvm-furniture.com/og-supreme.jpg"
        keywords="Supreme furniture Neemuch, Supreme dealer Neemuch, Supreme in Neemuch, Supreme chairs Neemuch, Supreme wholesale Madhya Pradesh, Supreme plastic furniture Neemuch, Supreme tables Neemuch, Supreme authorized dealer MP, सुप्रीम डीलर नीमच, सुप्रीम फर्नीचर नीमच, नीमच में सुप्रीम"
      ...
      <section className='relative min-h-[70vh] md:min-h-[80vh] flex items-center justify-center bg-gradient-to-b from-gray-50 via-white to-gray-50 overflow-hidden'>
        ...
        <div className='relative z-10 max-w-5xl mx-auto px-4 sm:px-6'>
          ...
          <div className='inline-flex items-center gap-2 px-4 py-2 rounded-full bg-orange-500/10 border border-orange-500/20 mb-6'>
            ...
            <span className='text-sm font-medium text-orange-600'>Authorized Wholesale Dealer</span>
          </div>
          ...
          <p className='text-lg md:text-xl text-gray-600 max-w-2xl mx-auto mb-4 leading-relaxed'>
            We are the <span className='text-gray-900 font-semibold'>Authorized Wholesale Dealer</span> of Supreme - by Supreme Industries Ltd, India's largest plastics company - serving Neemuch, Mandsaur, and all of Central India.
          </p>
                  ...
                  <div className='flex items-end justify-between mb-6'>
                    ...
                    {products.length > 0 && (
                      <Link
                        ...
                        className='hidden md:inline-flex items-center gap-1 text-sm font-medium text-orange-600 hover:text-orange-700 transition-colors shrink-0'
                      >
                        ...
                        {preview.map((product) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <div className='p-3'>
                                <h4 className='text-xs font-medium text-gray-800 leading-snug line-clamp-2 mb-1.5 group-hover:text-orange-600 transition-colors'>
                                  {title}
                                </h4>
                                <span className='text-[11px] font-medium text-orange-500 group-hover:text-orange-600 transition-colors'>
                                  View Details →
                                </span>
                              </div>
                            </Link>
