      ...
      <div className='min-h-screen bg-white'>
        ...
        <div className='pt-20 md:pt-24 pb-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10'>
          <div className='flex items-center gap-2 text-sm text-gray-500'>
            <Link to='/seatex' className='hover:text-gray-700 transition-colors'>Seatex</Link>
            <span>/</span>
            {cat && (
              <>
                <Link to={`/seatex/${collection}`} className='hover:text-gray-700 transition-colors'>
                  {cat.label}
                </Link>
                <span>/</span>
              </>
          ...
          <div className='flex flex-col lg:flex-row gap-10 lg:gap-16'>
            ...
            <div className='flex-1 lg:max-w-md'>
              ...
              <div className='flex flex-wrap items-center gap-2 mb-4'>
                <span className='text-xs px-2.5 py-1 rounded-full bg-emerald-50 border border-emerald-200 text-emerald-600 font-medium'>
                  Seatex
                </span>
              </div>
              ...
              {colorVariants.length > 0 && (
                <div className='mb-6'>
                  ...
                  <div className='flex flex-wrap gap-2'>
                    {colorVariants.map((v) => (
                      <span key={v.id} className='text-sm px-3 py-1 rounded-full bg-gray-50 border border-gray-200 text-gray-700'>
                        {v.title}
                      </span>
                    ))}
                  </div>
              ...
              <div className='flex items-end justify-between mb-6'>
                ...
                {cat && (
                  <Link
                    ...
                    className='text-sm text-emerald-600 hover:text-emerald-700 transition-colors inline-flex items-center gap-1'
                  >
                    View all
