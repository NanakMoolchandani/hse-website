      ...
      <section className='bg-gray-950 pt-24 pb-12 md:pt-28 md:pb-16'>
        <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-10'>
          ...
          <div className='flex items-center gap-2 text-sm text-gray-500 mb-6'>
            <Link to='/nilkamal' className='hover:text-gray-300 transition-colors inline-flex items-center gap-1'>
          ...
          <div className='flex flex-col md:flex-row md:items-end md:justify-between gap-4'>
            <div>
              <div className='inline-flex items-center gap-2 px-3 py-1 rounded-full bg-blue-500/10 border border-blue-500/20 mb-4'>
                ...
                <span className='text-xs font-medium text-blue-400'>Authorized Wholesale Dealer</span>
              </div>
            ...
            <div className='relative w-full md:w-72 shrink-0'>
              ...
              <input
                ...
                className='w-full pl-10 pr-9 py-2.5 bg-white/5 border border-white/10 rounded-xl text-sm text-white placeholder:text-gray-500 focus:outline-none focus:border-blue-500/40 focus:ring-1 focus:ring-blue-500/20 transition-colors'
              />
              {search && (
                <button
                  onClick={() => setSearch('')}
