      ...
      <div className='min-h-screen bg-gray-950'>
        ...
        <div className='pt-20 md:pt-24 pb-4 max-w-7xl mx-auto px-4 sm:px-6 lg:px-10'>
          <div className='flex items-center gap-2 text-sm text-gray-500'>
            <Link to='/supreme' className='hover:text-gray-300 transition-colors'>Supreme</Link>
            <span>/</span>
            {cat && (
              <>
                <Link to={`/supreme/${collection}`} className='hover:text-gray-300 transition-colors'>
                  {cat.label}
                </Link>
                <span>/</span>
              </>
          ...
          <div className='flex flex-col lg:flex-row gap-10 lg:gap-16'>
            ...
            <div className='flex-1 max-w-2xl'>
              ...
              <div className='relative aspect-square rounded-2xl bg-white/[0.03] border border-white/5 overflow-hidden mb-4'>
                {images.length > 0 ? (
                  <img
                    src={supremeImageUrl(images[activeImage].src, 1000)}
              ...
              {images.length > 1 && (
                <div className='flex gap-2 overflow-x-auto pb-2'>
                  {images.map((img, i) => (
                    ...
                    >
                      <img
                        src={supremeImageUrl(img.src, 100)}
            ...
            <div className='flex-1 lg:max-w-md'>
              ...
              <div className='flex flex-wrap items-center gap-2 mb-4'>
                <span className='text-xs px-2.5 py-1 rounded-full bg-orange-500/10 border border-orange-500/20 text-orange-400 font-medium'>
                  Supreme
                </span>
                {!isAvailable && (
